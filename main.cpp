...
int main() {
  ...
  //int s =450;
  //cout << "X_train[0][0] = s = " << X_train[s][0] <<endl;
  //cout << "X_train[0][1] = d = " << X_train[s][1] <<endl;
  //cout << "X_train[0][2] = s_dot = " << X_train[s][2] <<endl;
  //cout << "X_train[0][3] = d_dot = " << X_train[s][3] <<endl;
  //cout << "Y_train[0][0] = Y = " << Y_train[s] <<endl;
